...
This file is the catalog of *mechanisms*. Which one a page should use, and where it should fire, is decided by the subject — `reference/imagination.md`. A flagship picked from this list with no fact behind it reads as a demo.
