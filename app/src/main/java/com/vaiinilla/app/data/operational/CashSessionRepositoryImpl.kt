...
class RemoteCashSessionRepository(
    ...
    override fun openSession(initialAmount: String, idempotencyKey: String): Result<Unit> =
        apiClient.post(
            path = "sesiones-caja",
    ...
    override fun hasActiveSession(): Result<Boolean> = apiClient.get("sesiones-caja/activa")
